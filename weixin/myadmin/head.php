...
<div id="body-wrapper">
  ...
  <div id="sidebar">
    <div id="sidebar-wrapper">
      ...
      <!-- Logo (221px wide) -->
      <a href="#"><img id="logo" src="themes/images/nlogo.png" weight=10px height=45px alt="张凯" /></a>
      <!-- Sidebar Profile links -->
      <div id="profile-links"> 张凯（http://1343336983.duapp.com/wall）<br />
        <br />
        <a href="http://1343336983.duapp.com/wall" title="客服中心" target="_blank"><b>在线客服</b></a>&nbsp|&nbsp<a href="main.php" title="后台">后台首页</a>&nbsp|&nbsp<a href="logout.php" title="退出">退出</a></div>
      <ul id="main-nav">
        <!-- Accordion Menu -->
